...
<body>
    ...
    <div id="addquestiondiv" runat="server" class="text-center">
        ...
        <asp:Label runat="server" id="StatusLabel2" />
            ...
            <br /><br />
            <b>Categoria</b><br />
            <asp:DropDownList id ="ddlCategorias1" runat ="server" class="btn btn-default btn-lg">
        ...
        <asp:FileUpload id="FileUploadControl1" runat="server" class="btn btn-default btn-lg"/>
        <asp:Button runat="server" id="UploadButton1" text="Upload" onclick="UploadButton_Click1" class="btn btn-default btn-lg"/>
        <br /><br /><br />
        ...
        <br />
            ...
            <asp:DropDownList id ="ddlCategorias2" runat ="server" class="btn btn-default btn-lg">
                ...
                <asp:ListItem>Razmto. de figuras</asp:ListItem>
                <asp:ListItem>Razmto. cuantitativo</asp:ListItem>
            </asp:DropDownList>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ddlCategorias2" Display="Dynamic" ErrorMessage="Por favor ingrese la categoria" SetFocusOnError="true" ForeColor="Red" ValidationGroup="singleoptionvalidation" /><br /><br />
